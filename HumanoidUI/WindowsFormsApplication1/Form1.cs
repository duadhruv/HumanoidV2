...
namespace WindowsFormsApplication1
{
    ...
    {
        bool[] acheck = new bool[16];
        bool[] scheck = new bool[16];
        ...
        public void Update_Value()
        {
            ...
            String delta = (d1 - inipos[0]).ToString() + "," + (d2 - inipos[1]).ToString() + "," + (d3 - inipos[2]).ToString() + "," +
                (d4 - inipos[3]).ToString() + "," + (d5 - inipos[4]).ToString() + "," + (d6 - inipos[5]).ToString() + "," +
                (d7 - inipos[6]).ToString() + "," + (d8 - inipos[7]).ToString() + "," + (d9 - inipos[8]).ToString() + "," +
                (d10 - inipos[9]).ToString() + "," + (d11 - inipos[10]).ToString() + "," + (d12 - inipos[11]).ToString() + "," +
                (d13 - inipos[12]).ToString() + "," + (d14 - inipos[13]).ToString() + "," + (d15 - inipos[14]).ToString() + "," +
                (d16 - inipos[15]).ToString() + ";";
            deltatxt.Text = delta;
        ...
        private void serialread(String input)////////////read incoming data for servo angles
        {
        ...
        {
            String str = "$" + movename.Text;
            if(smartmove.Checked)
            {

                str = str + "S" + movetime.Text;
            }
            str = str + ";";
            try
            {
        ...
        private void execmove_Click(object sender, EventArgs e)
        {

            try
            {
                String name = "#" + execmovename.Text ;
                if(reverse.Checked)
                {
                    name = name + "R";
                }
                name = name + ";";
                serialPort1.Write(name);
        ...
        private void getlastmove_Click(object sender, EventArgs e)
        {
